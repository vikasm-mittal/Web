/// <binding AfterBuild='default, css-task, spa-task, vendors-task' />
/*
...
gulp.task("css-task", function () {
    ...
    var customCssStream = gulp.src(['./bower_components/bootstrap/dist/css/bootstrap.css', './Styles/site.css']);
